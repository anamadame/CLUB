    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(default='Default Photo Name', max_length=100, verbose_name='название продукта')),
            ],
        ),
        migrations.CreateModel(
            name='Basket',
            fields=[
                ...
                ('product_photo', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='blog.photo')),
            ],
        ),
        migrations.CreateModel(
            name='Model',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.ManyToManyField(blank=True, to='blog.color')),
                ('model', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='blog.model')),
                ('photos', models.ManyToManyField(blank=True, to='blog.photo', verbose_name='фото продукта')),
            ],
        ),
        migrations.CreateModel(
            name='Favorite',
